...
public class PaperBookSaveRequest extends BookSaveRequestGeneral{
    ...
    public PaperBookSaveRequest(String mainImage, String secondImage, String thirdImage, String name, Genre genre, int price, String author, String description, Language language, int yearOfIssue, int discount, boolean bestseller, String fragment) {
